...
const floorColorTexture = textureLoader.load('/haunted-house/floor/floor_texture/color.webp')
const floorARMTexture = textureLoader.load('/haunted-house/floor/floor_texture/arm.webp')
const floorNormalTexture = textureLoader.load('/haunted-house/floor/floor_texture/normal.webp')
const floorDisplacementTexture = textureLoader.load('/haunted-house/floor/floor_texture/displacement.webp')
